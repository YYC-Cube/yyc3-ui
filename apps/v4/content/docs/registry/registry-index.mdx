...
1. Add your registry to [`apps/v4/registry/directory.json`](https://github.com/YYC-Cube/yyc3-ui/blob/main/apps/v4/registry/directory.json)
2. Run `pnpm registry:build` to update `registries.json` file.
3. Create a pull request to https://github.com/YYC-Cube/yyc3-ui
